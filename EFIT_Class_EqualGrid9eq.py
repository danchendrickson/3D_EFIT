...
class EFIT:
    ...
    def DeltaStress(self,x,y,z):
        ...
        Ds[0,0] =  ((self.ids) *
            ((self.lmbda+2*self.mu)*(self.Gv[0,x+1,y,z]-self.Gv[0,x,y,z]) +
                        self.lmbda*(  (self.Gv[1,x,y,z]-self.Gv[1,x,y-1,z])  +
                                    (self.Gv[2,x,y,z]-self.Gv[2,x,y,z-1]))
                )
            )
        Ds[1,1] =  ((self.ids) *
            ((self.lmbda+2*self.mu)*(self.Gv[1,x,y+1,z]-self.Gv[1,x,y,z]) +
                        self.lmbda*(  (self.Gv[2,x,y,z]-self.Gv[2,x,y,z-1])  +
                                    (self.Gv[0,x,y,z]-self.Gv[0,x-1,y,z]))
                )
            )
        Ds[2,2] =  ((self.ids) *
            ((self.lmbda+2*self.mu)*(self.Gv[2,x,y,z+1]-self.Gv[2,x,y,z]) +
                        self.lmbda*(  (self.Gv[0,x,y,z]-self.Gv[0,x-1,y,z])  +
    ...
    def DeltaVelocity(self, x,y,z):
        ...
        DV[0] = ((self.ids ) / (self.rho) ) * (
                (self.Gs[0,0,x+1,y,z] - self.Gs[0,0,x,y,z]) +
                (self.Gs[1,0,x,y,z] - self.Gs[1,0,x,y-1,z]) + 
                (self.Gs[2,0,x,y,z] - self.Gs[2,0,x,y,z-1])
            )            
        DV[1] = ((self.ids ) / (self.rho) ) * (
                (self.Gs[0,1,x,y,z] - self.Gs[0,1,x-1,y,z]) +
                (self.Gs[1,1,x,y+1,z] - self.Gs[1,1,x,y,z]) + 
                (self.Gs[2,1,x,y,z] - self.Gs[2,1,x,y,z-1])
            )            
        DV[2] = ((self.ids ) / (self.rho) ) * (
